...
No script, no dependencies: `SKILL.md` plus the `references/` files an agent loads only when the task calls for them — the upstream comparison table and the CONTRIBUTING template
